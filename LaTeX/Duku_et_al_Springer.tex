...
\newpage
    ...
    \begin{figure}
      ...
      \caption{Changes in yield losses due to bacterial leaf blight disease expressed as tons per for two future time slices and three IPCC emission scenarios as predicted by the RICEPEST model. The change in yield is calculated as the difference of the future yield and a base time-slice, 2000 representing 1991 to 2010. Negative values indicate a higher yield loss in the future due to increased bacterial leaf blight disease severity. Positive values indicate lower yield losses in future due to decreased bacterial leaf blight disease severity. RICEPEST is a simple empirical growth model that simulates the growth, yield and yield losses due to pests and diseases of tropical rice based using temperature and radiation inputs and predetermined input levels that include irrigation and fertilization practices and disease severity as predicted by the EPIRICE model. The EPIRICE model predicts disease severity of unmanaged disease of susceptible rice varieties given temperature, relative humidity and precipitation.}
      \label{Fig7}
    \end{figure}
