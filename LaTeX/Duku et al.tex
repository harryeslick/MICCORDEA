    ...
    All code used for analysis and data used in this dataset are available from Figshare, http://figshare.com/articles/MICORDEA/1408501, and can also be cloned using git from GitHub, https://github.com/adamhsparks/MICORDEA. A Stella version of the original, complete version of the RICEPEST model by the original authors, L. Willocquet and S. Savary, is available for download from The American Phytopathological Society Education Center, \\
https://goo.gl/Y6KW6M.
