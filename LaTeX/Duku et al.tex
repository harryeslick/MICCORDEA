...
\begin{figure}[H]
  ...
  \caption{Attainable yield, the yield in the absence of yield reducing factors, in tons per hectare.}
\end{figure}
...
Except for the B1 2050 scenario and time slice for leaf blast, neither disease displays a distribution of yield losses that is similar to the base time slice. The base time slice for both diseases clusters around zero, whereas the future time slices tend to have the largest concentration of values above zero, suggesting that even though the maximum values may not indicate much change, overall there is a predicted increase in the yield losses due to disease.
