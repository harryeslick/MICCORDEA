...
\subsubsection{The EPIRICE model} % How does the EPIRICE model work? What assumption is made regarding the variety and susceptibility?
...
\begin{figure}[H]
  \includegraphics[width = 190mm]{Figures/BB_Yield_Loss_Change}
  \label{BB_Change_Map}
...
\citet
The results of this study indicate that the effects of climate change on plant disease can be expected to be uneven as the environment becomes less favourable for some diseases (e.g. LB), it becomes moreso for others (e.g. BB). 
