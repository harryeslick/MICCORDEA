...
Bacterial blight epidemics exhibited normal progress curves in all time slices and scenarios started rapidly increasing around day 50 and increased up until day 100, when it began decreasing (Figure \ref{BBCurves}). The AUDPC illustrates the differences between the time slices and scenarios more clearly (Table \ref{BBAUDPC}.
