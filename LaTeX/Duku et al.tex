...
Yield losses due to leaf blast were predicted to be quite low in Tanzania during all time slices and under all scenarios. Leaf blast was not predicted to cause losses of more than 0.015 tons per hectare (Figure \ref{LB_Losses_Violin}) under any timeslice and scenario combination. Differences between all timeslices and scenarios were negligible, however the base had the highest yield loss values, but lowest overall yield losses. The A2 2050 scenario exhibited the highest average yield losses of any scenario and time slice combination, but they were still less than 0.005 tons per hectare with the highest yeild loss being XXX.
