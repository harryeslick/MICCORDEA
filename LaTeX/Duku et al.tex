...
Yield losses due to leaf blast were predicted to be quite low in Tanzania during all time slices and under all scenarios. Leaf blast was not predicted to cause losses of more than 0.015 tons per hectare (Figure \ref{LB_Losses_Violin}) under any timeslice and scenario combination. Differences between all timeslices and scenarios were negligible, however the base had the highest yield loss values due to leaf blast, but lowest overall yield losses for the whole country. The A2 2050 scenario exhibited the highest average yield losses of any scenario and time slice combination, but they were still less than 0.005 tons per hectare with the highest yeild loss being XXX.
...
Bacterial blight was predicted to cause much greater losses than leaf blast, up to 0.6 tons per hectare (Figure \ref{BB_Losses_Violin}). The base timeslice and scenario again had the lowest predicted yield losses with XXX tons per hectare. The A2 2050 time slice had the highest yield losses, with a maximum of XXX tons per hectare and an average yield loss of XXX tons per hectare.
